...
export const ItemList = (md: MarkdownIt) => {
  md.use(markdownItContainer, 'itemList', {
    ...
    render: function (tokens: any, idx: any) {
      ...
      const text: StrType = params.length > 1 ? params[1] : 'item-info';
      const type: StrType = params.length > 1 ? params[0] : 'item-info';
      ...
      if (token.nesting === 1) {
        ...
        <p class="item-block-title">${text}</p>
